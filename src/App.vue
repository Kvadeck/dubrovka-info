...
import TheBuildings from '@/components/choose-flat/TheBuildingsMain.vue'
...
<template>
  ...
  <section class="relative bg-[var(--third-background)] py-[35px] pb-[35px] lg:px-[70px] lg:py-[40px] max-md:px-[20px] md:px-[35px]">
    <AdvantagesList />
  </section>
  <section class="relative bg-[var(--third-background)] py-[35px] pb-[35px] lg:px-[70px] lg:py-[40px] max-md:px-[20px] md:px-[35px]">
    <TheBuildings />
