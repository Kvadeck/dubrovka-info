...
<template>
  <div class="grid justify-center gap-[38px] px-[30px] lg:grid-cols-[minmax(200px,470px)_minmax(200px,880px)] md:grid-cols-[minmax(200px,280px)_minmax(200px,880px)] lg:gap-[130px]">
    <div class="relative">
